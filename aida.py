...
thankyoumessages = ["For You Sir Always, at your service"]
msg = welcome_msg()
...
while (True):
    ...
    if "love" in x:
        ...
        os.system("notepad")
    elif ("run" in x or "execute" in x or "open" in x) and ("music" in x or "spotify" in x or "Spotify" in x):
        print(Fore.CYAN + "Opening Spotify" + Fore.RESET)
        speak("Opening Spotify")
        os.system("Spotify")
    elif ("run" in x or "execute" in x or "open" in x) and ("itunes" in x or "apple" in x or "itnune" in x):
        print(Fore.CYAN + "Opening iTunes" + Fore.RESET)
        speak("Opening iTunes")
        os.system("iTunes")
    elif ("run" in x or "execute" in x or "open" in x) and ("file" in x or "files" in x or "drive" in x):
        print(Fore.CYAN + "Opening File Explorer" + Fore.RESET)
        speak("Opening File Explorer")
        os.system("File Explorer")
    elif (("run" in x) or ("execute" in x) or ("open" in x)) and ("youtube" in x):
        speak("opening, youtube")
        os.system("start explorer http://youtube.com")
    elif (("run" in x) or ("execute" in x) or ("open" in x)) and ("google" in x):
        speak("opening, google")
        os.system("start explorer http://google.com")
    elif (("run" in x) or ("execute" in x) or ("open" in x)) and ("my github" in x):
        speak("opening, github")
        os.system("start explorer https://github.com/akashmittal18")